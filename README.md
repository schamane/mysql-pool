...
Простой пул открытых соединений к базе данных MySQL для драйвера [felixge/node-mysql v2.0](https3://github.com/felixge/node-mysql)
с функцией автоматического возврата соединения в пул.
##Текущая версия##
